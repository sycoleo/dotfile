...
local plug_map = {
	...
	-- Plugin Telescope
	["n|<C-s>"] = map_cu("lua require('telescope').extensions.project.project{}"):with_noremap():with_silent(),
	["n|<C-r>"] = map_cu("lua require('telescope').extensions.frecency.frecency{}"):with_noremap():with_silent(),
	["n|<C-h>"] = map_cu("DashboardFindHistory"):with_noremap():with_silent(),
	["n|<C-f>"] = map_cu("DashboardFindFile"):with_noremap():with_silent(),
	["n|<Leader>sc"] = map_cu("DashboardChangeColorscheme"):with_noremap():with_silent(),
	["n|<Leader>fp"] = map_cu("DashboardFindWord"):with_noremap():with_silent(),
